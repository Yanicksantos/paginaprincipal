        ...
        <div style="background-image: url('/1.webp'); background-size: cover; background-position: center center; height: 400px;" class="d-sm-none">
            <div class="w-100 h-100 d-flex justify-center align-center pa-2 " style="background-color: rgba(0, 0, 0, .75);">
                <div class="elevation-24 pa-4 rounded" style="background-color: rgba(0, 0, 0, .3);">
                    ...
                    <p class="my-8 text-caption text-md-body-1 font-weight-light text-grey-lighten-1">A Pred Engenharia é especializada em oferecer soluções para a gestão eficiente de
                        ativos e processos. Desde 1993, trabalhamos para garantir a <span class=" text-body-1 text-white">segurança,
                        confiabilidade e produtividade das operações e manutenções (O&M) na indústria e
                        em serviços.</span> </p>
                    <div 
